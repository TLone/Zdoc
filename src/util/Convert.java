...
public class Convert {
	/**
	 * 将Office文档转换为PDF 需要openoffice服务 需要配置String command ！！！
	 * 
	 * @param destFile
	...
	public int pdf2swf() {
		try {
			...
			pro.destroy();
			System.out.println("pdf2swf success");
			return 0;
		} catch (FileNotFoundException e) {
			e.printStackTrace();
			return -1;
	...
	public static void main(String[] args) {
		 Convert c=new
		 Convert("/test/a.doc","/test/a.pdf","/test/a.swf");
		// c.office2PDF();
		 c.pdf2swf();
		// String
		// command="pdf2swf -s languagedir=/usr/local/xpdf-chinese-simplified -T 9 -s poly2bitmap -s zoom=150 -s flashversion=9 /root/Desktop/word2pdf.pdf -o /root/Desktop/pdf2swf.swf";
		// try {
		// Process pro = Runtime.getRuntime().exec(command);
		//			
		//			
